...
var convertToInternalCode = function () {
  ...
  if (document.getElementById("binary").checked) {
    ...
    if (document.getElementById("big5").checked) {
      ...
      for (
        var i = 0;
        i < document.getElementById("character").value.length;
        ++i
      ) {
        internalCode +=
          unicodeToBig5[
            document.getElementById("character").value.charCodeAt(i)
          ].toString(2) + " ";
      }
      ...
      for (
        ...
        internalCode +=
          document.getElementById("character").value.charCodeAt(i).toString(2) +
          " ";
      }
    }
...
var convertToCharacter = function () {
  ...
  if (document.getElementById("binary").checked) {
    ...
    if (document.getElementById("big5").checked) {
      ...
      for (var i = 0; i < internalCodeArray.length; ++i) {
        character += String.fromCharCode(
          big5ToUnicode[parseInt(internalCodeArray[i], 2)]
        );
      }
    } else if (document.getElementById("unicode").checked) {
      // Unicode
    ...
    if (document.getElementById("big5").checked) {
      ...
      for (var i = 0; i < internalCodeArray.length; ++i) {
        character += String.fromCharCode(
          big5ToUnicode[parseInt(internalCodeArray[i], 16)]
        );
      }
    } else if (document.getElementById("unicode").checked) {
      // Unicode
      for (var i = 0; i < internalCodeArray.length; ++i) {
        character += String.fromCharCode(parseInt(internalCodeArray[i], 16));
      }
    }
  }
...
// Big5 與 Unicode 對照表
// 來源：http://tw.knowledge.yahoo.com/question/question?qid=1206052203390
//       http://moztw.org/docs/big5/table/big5_2003-b2u.txt
var Big5UnicodeTable = [
  [0x8140, 0xeeb8],
  [0x8141, 0xeeb9],
  [0x8142, 0xeeba],
  [0x8143, 0xeebb],
